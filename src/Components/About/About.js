...
const About = () => {
  ...
  return (
    <div>
      ...
      <div className="banner">
        ...
        <div className="banner-text">
          <h1 style={{ color: 'black' }}>Welcome to Our Company</h1>
          <strong> <p style={{ color: 'black' }}>Providing futuristic business solutions for a smarter tomorrow.</p></strong>
        </div>
      </div>
      ...
      <div className="abt-cards-container">
        <div className="abt-card mission-card">
          <h1 className='about-mis'>Mission</h1>
          <p>
            To create unimaginable, futuristic and scalable solutions and to take them worldwide.
        ...
        <div className="abt-card vision-card">
          <h1 className='about-vis'>Vision</h1>
          <p>
            To innovate solutions that go above and beyond the clients’ expectations and to provide them with end-to-end solutions. We strive to shape dreams into reality.
    ...
    <div className="Progress-container">
      ...
      <div className="container keypoints-container">
      <div className="row">
        <div className="col-md-6 mb-4">
          <div className="keypoint card shadow-sm p-4">
            <h2>01 Work with Confidence</h2>
            <p>We promise what we know we can deliver and we deliver what we had promised. This confidence comes from our reliable and integrated work processes.</p>
          </div>
        </div>
        <div className="col-md-6 mb-4">
          <div className="keypoint card shadow-sm p-4">
            <h2>02 Ensure Success</h2>
            <p>We believe that capabilities are proven when the promises are delivered in time. When reliable, practical and in-time solutions are delivered as a habit, success is guaranteed.</p>
          </div>
        </div>
        <div className="col-md-6 mb-4">
          <div className="keypoint card shadow-sm p-4">
